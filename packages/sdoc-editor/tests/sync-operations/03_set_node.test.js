...
describe('construct clientEditor and serverEditor', () => {
  it('client editor: execute ops', () => {
    ...
    const op2 = {
      ...
      type: 'set_node',
      path: [3],
      properties: { type: 'paragraph', id: 'ddd' },
      newProperties: { type: 'check_list_item', id: 'ddd' }
    };
    const ops = [op1, op2];
  ...
  it('server editor: execute ops, set_node', () => {
    const remote_op1 = {
      ...
      path: [3],
      properties: { type: 'paragraph', id: 'ddd' },
      newProperties: { type: 'blockquote', id: 'ddd' }
    };
...
describe('sync operations:insert_text&set_node', () => {
  it('revert ops', () => {
    // revert operations
