...
const RebaseDeleteModifyDecorate = ({ element, children }) => {
  ...
  return (
    <>
      <div className="sdoc-rebase-btn-group" contentEditable={false}>
        <div className="sdoc-rebase-btn" onClick={deleteElement}>{t('Keep_other_modification')}</div>
        <div className="mr-2 ml-2">{'|'}</div>
        <div className="sdoc-rebase-btn" onClick={deleteMark}>{t('Keep_my_modification')}</div>
        <div className="mr-2 ml-2">{'|'}</div>
      ...
      <div className="sdoc-rebase-other-changes empty" contentEditable={false}></div>
...
RebaseDeleteModifyDecorate.propTypes = {
