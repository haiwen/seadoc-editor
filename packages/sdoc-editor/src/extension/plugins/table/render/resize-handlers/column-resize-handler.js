...
const ColumnResizeHandler = ({ column, left: initLeft, table, cellIndex, rowBottom, hideResizeHandlers, mouseDownEvent, adjustingCell, isDraggingResizeHandler }) => {
  ...
  useEffect(() => {
    ...
    const onMouseUp = (event) => {
      ...
      if (nextColumn) {
        ...
        newColumns[cellIndex + 1] = { ...nextColumn, width: nextColumnWidth };
      }
