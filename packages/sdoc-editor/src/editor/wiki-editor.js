...
import { INTERNAL_EVENT, MATH_JAX_SOURCE_RUL, WIKI_EDITOR_EDIT_AREA_WIDTH } from '../constants';
...
const WikiEditor = forwardRef(({ editor: propsEditor, document, isReloading, isWikiReadOnly, scrollRef, showComment, mathJaxSource = MATH_JAX_SOURCE_RUL }, ref) => {
